module "vpc" {
  source                  = "../../modules/f01_gcp_vpc_network"
...
module "subnet" {
  source           = "../../modules/f02_gcp_vpc_subnet"
...
module "allow_http_https" {
  source         = "../../modules/f03_gcp_firewall_rule"
  project_id     = var.project_id
...
module "artifact_registry_repository" {
  source         = "../../modules/a03_gcp_artifact_registry_repository"
  project_id = var.project_id
  region = var.region
